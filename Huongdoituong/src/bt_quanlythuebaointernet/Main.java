...
public class Main {
	...
	public static void main(String[] args) {
        ...
        do {
        	System.out.print("Chọn chức năng từ 1->8 : ");
        	choose=scanner.nextInt();
        	
        	switch(choose) {
        	case 1: 
        		System.out.print("Số phút truy cập: ");
        		soPhutTruyCap=scanner.nextInt();
        		thueBao=new DialUp(soPhutTruyCap);
        		danhSachThueBao.themThongTin(thueBao);
        		System.out.println("Thêm thành công thuê bao Dial Up có số phút truy cập = "+soPhutTruyCap);
        		break;
        	case 2:
        		System.out.println("Nhập số MB truy cập: ");
        		soMBTruyCap=scanner.nextInt();
        		thueBao=new ADSL(soMBTruyCap);
        		danhSachThueBao.themThongTin(thueBao);
        		System.out.println("Thêm thành công thuê bao ADSL có số MB truy cập = " +soMBTruyCap);
                break;
        	case 3:
        		thueBao=new T1();
        		danhSachThueBao.themThongTin(thueBao);
        	...
        	case 4:
        		 ...
        		 danhSachThueBao.hienThiDanhSach();
        		 break;
        	case 5:
