	...
	public static void main(String[] args) {
        ...
        do {
        	...
        	case 1:
        		...
        		System.out.println("Thêm thành công hình chữ nhật có chiều dài = "+chieuDai+", Chiều rộng = "+chieuRong);
        		break;
        	case 2:
        		random=new Random();
        	...
        	case 3:
        		...
        		break;
        	case 4:
        		System.out.println("Số lượng hình chữ nhật = "+danhSachHinh.demSoHinhChuNhat());
        		break;
        	case 5:
