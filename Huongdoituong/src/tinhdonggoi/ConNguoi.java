...
public class ConNguoi {
	...
	public void setHoTen(String hoTen) {//Tham trị là một biến cục bộ trùng tên với thuộc tính họ tên
		this.hoTen=hoTen;//sử dụng this để gọi lên thuộc tính của đối tượng và gán bằng với biến cục bộ
	}
