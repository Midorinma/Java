...
public class PhanSo {
	...
	public void nhanPhanSo(PhanSo ps) {
		...
		System.out.println("Tích hai phân số= "+tichPhanSo.tu+"/"+tichPhanSo.mau);
	}
	...
	public void chiaPhanSo(PhanSo ps) {
		...
		System.out.println("Thương hai phân số: "+thuongPhanSo.tu+"/"+thuongPhanSo.mau);
	}
